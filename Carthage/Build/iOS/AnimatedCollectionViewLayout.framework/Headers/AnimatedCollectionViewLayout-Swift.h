...
SWIFT_MODULE_NAMESPACE_PUSH("AnimatedCollectionViewLayout")
@class UICollectionViewLayoutAttributes;
@class NSCoder;

/// A <code>UICollectionViewFlowLayout</code> subclass enables custom transitions between cells.
SWIFT_CLASS("_TtC28AnimatedCollectionViewLayout28AnimatedCollectionViewLayout")
...
SWIFT_CLASS("_TtC28AnimatedCollectionViewLayout38AnimatedCollectionViewLayoutAttributes")
...
/// The ratio of the distance between the <em>start</em> of the cell and the end of the collectionView and the height/width of the cell depending on the scrollDirection. It’s 0 when the <em>start</em> of the cell aligns the end of the collectionView. It gets positive when the cell moves towards the scrolling direction (right/down) while getting negative when moves opposite.
